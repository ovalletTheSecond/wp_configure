 ...
 */
function ic_sanitize_image_carousel( $file, $setting ) {
	...
	public function registerCarouselChild($index = 0)
	{


		$this->add_setting(
			'carousel_firstelement_active_'.$index,
			array(
				'default'    => get_option( 'carousel_firstelement_active_'.$index ),
				'type'       => 'option',
		...
		$this->add_control(
			'carousel_firstelement_active_'.$index,
			array(
				'label'   => 'Activer l\' element '.$index.' du carousel ecrivez "false ou 0 pour desactiver"' ,
				'section' => 'carousel_section_acceuil',
			)
		);

				// 'carousel_firstelement_title_'.$i
				$this->add_setting(
					'carousel_firstelement_title_'.$index,
					array(
						'default'    => get_option( 'carousel_firstelement_title_'.$index ),
						'type'       => 'option',
						'capability' => 'manage_options',
					)
				);
				...
				$this->add_control(
					'carousel_firstelement_title_'.$index,
					array(
						'label'   => 'Titre de l\'element n°'.$index ,
						'section' => 'carousel_section_acceuil',
					)
				);
		...
		$this->add_setting(
			'carousel_firstelement_image_'.$index,
			array(
				'default'    => get_option( 'carousel_firstelement_image_'.$index ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'carousel_firstelement_image_'.$index,
			array(
				'label'   => 'l\'Image pour l\'élément '.$index.' -uploadez au desses et ajouter sur URL ici (upload not working at least local)-"' ,
				'section' => 'carousel_section_acceuil',
			)
		);
		...
		$this->add_setting(
			'carousel_firstelement_text_'.$index,
			array(
				'default'    => get_option( 'carousel_firstelement_text_'.$index ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'carousel_firstelement_text_'.$index,
			array(
				'label'   => 'Texte de l\'element n°'.$index ,
				'section' => 'carousel_section_acceuil',
			)
		);

		$this->add_setting(
			'carousel_firstelement_link_'.$index,
			array(
				'default'    => get_option( 'carousel_firstelement_link_'.$index ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'carousel_firstelement_link_'.$index,
			array(
				'label'   => 'Lien de l\'element n°'.$index ,
				'section' => 'carousel_section_acceuil',
			)
		);
	...
	public function registerBannerBulle()
	{
		$this->add_section(
			'banner_bulle',
			array(
		...
		$this->add_setting(
			'banner_bulle_title_one',
			array(
				'default'    => get_option( 'banner_bulle_title_one' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'banner_bulle_title_one',
			array(
				'label'   => 'Titre de la bulle' ,
				'section' => 'banner_bulle',
			)
		);

		$this->add_setting(
			'banner_bulle_title_two',
			array(
				'default'    => get_option( 'banner_bulle_title_two' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_setting(
			'banner_bulle_title_three',
			array(
				'default'    => get_option( 'banner_bulle_title_three' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'banner_bulle_title_three',
			array(
				'label'   => 'Lien de la bulle' ,
				'section' => 'banner_bulle',
			)
		);

		$this->add_setting(
			'banner_bulle_title_four',
			array(
				'default'    => get_option( 'banner_bulle_title_four' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
	...
	public function registerFooter()
	{
		...
		$this->add_setting(
			...
			array(
				'default'    => get_option( 'footer_column_one_title' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'footer_column_one_title',
			array(
				'label'   => 'Texte du titre la premiere colonne du  footer' ,
	...
	public function registerTheCarousel()
	{

		$this->add_section(
			'carousel_section_acceuil',
			array(
				'title'    => __( 'Elements du carousel/slider de l\'acceuil' ),
				'priority' => 20,
			)
		);
				...
				// // carousel element background-image
				// $index = 1;

				// $this->add_setting( 'logo_carousel'.$index, array(
				// 	'capability'        => 'manage_options',
				// 	'default'           => '',
				// 	'sanitize_callback' => 'ic_sanitize_image_carousel',
				// ) );
				// $this->add_control( new WP_Customize_Image_Control( $this, 'logo_carousel'.$index,
				// 	array(
				// 		'label'    => __( 'Logo'.$index, 'text-domain' ),
				// 		'section'  => 'carousel_section_acceuil',
				// 		'settings' => 'logo_carousel'.$index,
				// 	)
				// ) );



		$this->registerCarouselChild(1);
		$this->registerCarouselChild(2);
		$this->registerCarouselChild(3);
		$this->registerCarouselChild(4);
		$this->registerCarouselChild(5);
		$this->registerCarouselChild(6);
		$this->registerCarouselChild(7);
		$this->registerCarouselChild(8);
		$this->registerCarouselChild(9);
		$this->registerCarouselChild(10);

	}

	public function registerPartenairesType($index, $indextype)
	{
		$this->add_setting(
			'partenaire_type_name'.$indextype.'_'.$index,
			array(
				'default'    => get_option( 'partenaire_type'.$indextype.'_'.$index ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'partenaire_type_name'.$indextype.'_'.$index,
			array(
				'label'   => 'Nom du partenaire type '.$indextype.'  n°'.$index ,
				'section' => 'partenaire_page',
			)
		);

		$this->add_setting(
			'partenaire_type'.$indextype.'_link_'.$index,
			array(
				'default'    => get_option( 'partenaire_type'.$indextype.'_link_'.$index ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'partenaire_type'.$indextype.'_link_'.$index,
			array(
				'label'   => 'Lien du partenaire type '.$indextype.' n°'.$index ,
				'section' => 'partenaire_page',
			)
		);

		$this->add_setting(
			'partenaire_type'.$indextype.'_logo_'.$index,
			array(
				'default'    => get_option( 'partenaire_type'.$indextype.'_logo_'.$index ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'partenaire_type'.$indextype.'_logo_'.$index,
			array(
				'label'   => 'Logo du partenaire  type '.$indextype.' n°'.$index ,
				'section' => 'partenaire_page',
			)
		);
	}

	public function registerPartenairePage()
	{
		$this->add_section(
			'partenaire_page',
			array(
		...
		$this->add_setting(
			'title_text_partenaires',
			array(
				'default'    => get_option( 'title_text_partenaires' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'title_text_partenaires',
			array(
				'label'   => 'Site Title page partenaire' ,
				'section' => 'partenaire_page',
			)
		);
		...
		$this->add_setting(
			'subtitle_text_partenaires',
			array(
				'default'    => get_option( 'subtitle_text_partenaires' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'subtitle_text_partenaires',
			array(
				'label'   => 'le sous titre de la page partenaire' ,
				'section' => 'partenaire_page',
			)
		);

		$this->add_setting(
			'subtitle_text_partenaires_second',
			array(
				'default'    => get_option( 'subtitle_text_partenaires_second' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_setting(
			'subtitle_text_partenaires_type1',
			array(
				'default'    => get_option( 'subtitle_text_partenaires_type1' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'subtitle_text_partenaires_type1',
			array(
				'label'   => '[[titre partenaire type 1]]' ,
				'section' => 'partenaire_page',
			)
		);

		$this->registerPartenairesType(1 ,1);
		$this->registerPartenairesType(2,1);
		$this->registerPartenairesType(3,1);
		$this->registerPartenairesType(4,1);
		$this->registerPartenairesType(5,1);




		$this->add_setting(
			'subtitle_text_partenaires_type2',
			array(
				'default'    => get_option( 'subtitle_text_partenaires_type2' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'subtitle_text_partenaires_type2',
			array(
				'label'   => '[[titre partenaire type 2]]' ,
				'section' => 'partenaire_page',
			)
		);

		$this->registerPartenairesType(1,2);
		$this->registerPartenairesType(2,2);
		$this->registerPartenairesType(3,2);
		$this->registerPartenairesType(4,2);
		$this->registerPartenairesType(5,2);
	...
	public function registerAProposPage()
	{
		$this->add_section(
			'a_propos_page',
			array(
		...
		$this->add_setting(
			'title_text_a_propos',
			array(
				'default'    => get_option( 'title_text_a_propos' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'title_text_a_propos',
			array(
				'label'   => 'Site Title page a propos' ,
				'section' => 'a_propos_page',
			)
		);

		$this->add_setting(
			'subtitle_text_a_propos',
			array(
				'default'    => get_option( 'subtitle_text_a_propos' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		$this->add_control(
			'subtitle_text_a_propos',
			array(
				'label'   => 'le sous titre de la page a propos' ,
				'section' => 'a_propos_page',
			)
		);

		$this->add_setting('text_intro_a_propos' , array(
			'default'    => get_option( 'text_intro_a_propos' ),
			'type'       => 'option',
			'capability' => 'manage_options',
		));
		$this->add_control('text_intro_a_propos' , array(
			'label'   => 'Texte d\'introduction de la page a propos' ,
			'section' => 'a_propos_page',
		));
		...
		$this->add_setting('a_propos_amu_text' , array(
			'default'    => get_option( 'a_propos_amu_text' ),
			'type'       => 'option',
			'capability' => 'manage_options',
		));

		$this->add_control('a_propos_amu_text' , array(
			'label'   => 'Texte de la page a propos' ,
			'section' => 'a_propos_page',
		));

		$this->add_setting('a_propos_amu_image' , array(
			'default'    => get_option( 'a_propos_amu_image' ),
			'type'       => 'option',
			'capability' => 'manage_options',
		));

		$this->add_control('a_propos_amu_image' , array(
			'label'   => 'Image de la page a propos' ,
			'section' => 'a_propos_page',
		));

		$this->add_setting('a_propos_cnrs_text' , array(
			'default'    => get_option( 'a_propos_amu_link' ),
			'type'       => 'option',
			'capability' => 'manage_options',
		));

		$this->add_control('a_propos_cnrs_text' , array(
			'label'   => 'Texte de la page a propos' ,
			'section' => 'a_propos_page',
		));


		$this->add_setting('a_propos_cnrs_image' , array(
			'default'    => get_option( 'a_propos_cnrs_image' ),
			'type'       => 'option',
			'capability' => 'manage_options',
		));

		$this->add_control('a_propos_cnrs_image' , array(
			'label'   => 'Image de la page a propos' ,
			'section' => 'a_propos_page',
		));
	...
	public function registerContactusPage()
	{
			$this->add_section(
				'contactus_page',
				array(
			...
			$this->add_setting(
				'email_contactus',
				array(
					'default'    => get_option( 'the email of contact' ),
					'type'       => 'option',
					'capability' => 'manage_options',
				)
			);
			...
			$this->add_setting(
				'phone_contactus',
				array(
					'default'    => get_option( 'the phone of contact' ),
					'type'       => 'option',
					'capability' => 'manage_options',
				)
			);
			...
			$this->add_setting(
				'address_contactus',
				array(
					'default'    => get_option( 'the address of contact' ),
					'type'       => 'option',
					'capability' => 'manage_options',
				)
			);
	...
	public function registerIncomingPage()
	{
		$this->add_section(
			'coming_soon',
			array(
		...
		$this->add_setting(
			'title_text_incoming',
			array(
				'default'    => get_option( 'title_text_incoming' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'title_text_incoming',
			array(
				'label'   => 'Site Title page Coming Soon' ,
				'section' => 'coming_soon',
			)
		);

		$this->add_setting(
			'subtitle_text_incoming',
			array(
				'default'    => get_option( 'subtitle_text_incoming' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'subtitle_text_incoming',
			array(
				'label'   => 'le sous titre de la page Incoming' ,
				'section' => 'coming_soon',
			)
		);
		...
		$this->add_setting(
			'text_intro_incoming',
			array(
				'default'    => get_option( 'text_intro_incoming' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'text_intro_incoming',
			array(
				'label'   => 'Texte d\'introduction de la page Coming soon' ,
				'section' => 'coming_soon',
			)
		);
		...
		// 	'link_text_incoming',
		// 	array(
		// 		'default'    => get_option( 'link_text_incoming' ),
		// 		'type'       => 'option',
		// 		'capability' => 'manage_options',
		// 	)
		// );
	...
	public function register_controls() {
		...
		// register the "is_coming_soon setting"

		$this->add_section(
			'coming_soon',
			array(
				'title'    => 'Website est-il prêt ?',
				'priority' => 19,
			)
		);
		...
		$this->add_setting(
			'is_coming_soon',
			array(
				'default'    => get_option( 'is_coming_soon' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'is_coming_soon',
			array(
				'label'   => 'Website est-il prêt ?' ,
				'section' => 'coming_soon',
			)
		);

		$this->registerTheCarousel();
		$this->registerPartenairePage();
		$this->registerAProposPage();
		$this->registerContactusPage();
		$this->registerBannerBulle();
		$this->registerIncomingPage();
		...
		$this->add_setting(
			'titre_page_programme',
			array(
				'default'    => get_option( 'titre_page_programme' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		$this->add_control(
			'titre_page_programme',
			array(
				'label'   => 'Site Title page programme' ,
				'section' => 'page_programme',
			)
		);
		$this->add_setting(
			'sous_titre_page_programme',
			array(
				'default'    => get_option( 'sous_titre_page_programme' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		$this->add_control(
			'sous_titre_page_programme',
			array(
				'label'   => 'le sous titre de la page programme' ,
				'section' => 'page_programme',
			)
		);

	// then add 2 texts settings : alert_text_programme_title and alert_text_programme_content
	$this->add_setting(
		'alert_mode_programme',
		array(
			'default'    => get_option( 'alert_mode_programme' ),
			'type'       => 'option',
			'capability' => 'manage_options',
		)
	);
	$this->add_control(
		'alert_mode_programme',
		array(
			'label'   => 'alert_mode_programme' ,
			'section' => 'page_programme',
		)
	);
		
	$this->add_setting(
		'alert_text_programme_content',
		array(
			'default'    => get_option( 'alert_text_programme_content' ),
			'type'       => 'option',
			'capability' => 'manage_options',
		)
	);
	...
	$this->add_setting(
		'alert_text_programme_title',
		array(
			'default'    => get_option( 'alert_text_programme_title' ),
			'type'       => 'option',
			'capability' => 'manage_options',
		)
	);
	...
	$this->add_setting(
		'interractive-map-text',
		array(
			'default'    => get_option( 'interractive-map-text' ),
			'type'       => 'option',
			'capability' => 'manage_options',
		)
	);
	$this->add_control(
		'interractive-map-text',
		array(
			'label'   => 'Texte de la carte interractive' ,
			'section' => 'page_programme',
		)
	);
		...
		// adds a checkbox true or false for alert_mode_programme
		$this->add_setting(
			'alert_mode_programme',
			array(
				'default'    => get_option( 'alert_mode_programme' ),
				'type'       => 'option',
				'capability' => 'page_programme',
			)
		);
		...
		$this->add_control(
			'alert_mode_programme',
			array(
				'label'   => 'alert_mode_programme - tapez désactivé pour désactiver la popup, toute autre valeur activera l\'alerte' ,
				'section' => 'page_programme',
			)
		);
		...
		$this->add_section(
			...
			array(
				...
				// adds a checkbox true or false for alert_mode_programme
				$this->add_setting(
					'title_text_programme',
					array(
						'default'    => get_option( 'title_text_programme' ),
						'type'       => 'option',
						'capability' => 'page_programme',
					)
				);
				...
				$this->add_setting(
					'subtitle_text_programme',
					array(
						'default'    => get_option( 'subtitle_text_programme' ),
						'type'       => 'option',
						'capability' => 'page_programme',
					)
				);
				...
				$this->add_setting(
					'text_programme',
					array(
						'default'    => get_option( 'text_programme' ),
						'type'       => 'option',
						'capability' => 'page_programme',
					)
				);
		...
		$this->add_setting(
			'blogsubdescription',
			array(
				'default'    => get_option( 'blogsubdescription' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_setting(
			'banner_acceuil_title',
			array(
				'default'    => get_option( 'banner_acceuil_title' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'banner_acceuil_title',
			array(
				'label'   => __( 'Sous titre de la première bannière' ),
				'section' => 'title_tagline',
			)
		);
		...
		$this->add_setting(
			'banner_acceuil_contenu',
			array(
				'default'    => get_option( 'banner_acceuil_contenu' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'banner_acceuil_contenu',
			array(
				'label'   => __( 'Contenu de la bannière de la page d\'acceuil' ),
				'section' => 'title_tagline',
			)
		);
		...
		$this->add_setting(
			'tempfortstitle',
			array(
				'default'    => get_option( 'tempfortstitle' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'tempfortstitle',
			array(
				'label'   => __( 'Titre des temps forts' ),
				'section' => 'title_tagline',
			)
		);
		...
		$this->add_setting(
			'tempfortssubtitle',
			array(
				'default'    => get_option( 'tempfortssubtitle' ),
				'type'       => 'option',
				'capability' => 'manage_options',
			)
		);
		...
		$this->add_control(
			'tempfortssubtitle',
			array(
				'label'   => __( 'Sous Sous titre des temps forts' ),
				'section' => 'title_tagline',
			)
		);
